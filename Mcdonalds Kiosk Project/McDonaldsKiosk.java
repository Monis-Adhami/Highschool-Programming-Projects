...
/**
 * This is a program simulation of a McDonalds Kiosk, where the user can essentially order anything on the menu given. He will then be given the total of his purchase and even
...
public class McDonaldsKiosk {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Mcdonalds, I am an automated chat bot that will be helping you through your selection process...");
        double sandwich;
        double combo;
        double nuggets;
        double happymeal;
        ...
        while (finished == false) {
            ...
            if (meal.equals("1")) {
                ...
                System.out.println("A Combo meal will be $12. Please select between a pepsi and a fanta for your drink [pepsi/fanta]");
                ...
                if (meal.equals("2")) {
                    ...
                    if (meal.equals("3")) {
                        ...
                        System.out.println("The chicken nuggets will be $3.99, would you like the sauce with them? [yes/no]");
                        ...
                        if (meal.equals("4")) {
                            ...
                            System.out.println("The Happy Meal will be $2.99, Would you like the toy with it? [yes/no]");
        ...
        if (dessert.equals("yes")) {
            ...
            if (dessertType.equals("mcflurry")) {
                System.out.println("Please select a Mcflurry flavor: [oreo/smarties]");
                ...
                System.out.println("Please select a sundae flavor [fudge/sundae]");
        ...
        System.out.println("Would you like to complete your order and be transferred to the payment menu? [yes/no]");
